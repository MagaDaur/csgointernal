...
extern CInput* g_pGameInput;

class CInputSystem {
public:
    bool IsKeyDown(ButtonCode_t key) {
        using IsKeyDown_t = bool(__thiscall*)(void*, ButtonCode_t);
        return Utils::GetVFunc<IsKeyDown_t>(this, 15)(this, key);
    }
};
