...
public:
	...
	{
		ColorModulate(col.red, col.green, col.blue);
		AlphaModulate(col.alpha / 255.f);
	}
};
...
public:
	void SetVecValue(float r, float g, float b) {
		...
		Utils::GetVFunc<SetVecValueFn>(this, 11)(this, r, g, b);
	}
	void SetColor(Color clr)
	{
		SetVecValue(clr.red, clr.green, clr.blue);
	}
};