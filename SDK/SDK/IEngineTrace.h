...
public:
	...
	virtual void ClipRayToEntity(const Ray_t&               ray, unsigned int       fMask, IHandleEntity* pEnt, C_Trace*         pTrace) = 0;
	virtual void ClipRayToCollideable(const Ray_t&          ray, unsigned int       fMask, ICollideable*  pCollide, C_Trace*     pTrace) = 0;
	virtual void TraceRay(const Ray_t&                      ray, unsigned int       fMask, ITraceFilter*  pTraceFilter, C_Trace* pTrace) = 0;
	virtual bool ClipRayToHitboxes(const Ray_t& ray, unsigned int fMask, ICollideable* pCollideable, C_Trace* pTrace) = 0;
};
